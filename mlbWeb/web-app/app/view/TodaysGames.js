Ext.define('MlbApp.view.TodaysGames', {
	extend: 'Ext.Panel',
	alias: 'widget.todaysgamespanel',
	itemId: 'todaysgamespanel',
	title: 'Today\'s Games',
	collapsible: true,
	padding: '10 10 10 10',
	width: '100%',
	...
	listeners: {
        afterrender: function() {
        	...
        	Ext.Ajax.request({
        		url: MlbApp.common.Globals.root + "api/games/today",
        		success: function(response)
        		{
        			...
        			var todaysgamespanel = Ext.ComponentQuery.query('#todaysgamespanel')[0];
        			...
        			if(games.length<1)
        			{
        				var panel = new Ext.panel.Panel({
        		            html: '<p>&nbsp;&nbsp;&nbsp;No games on schedule today.</p>'
        				});
        				
        				var todaysgamespanel = Ext.ComponentQuery.query('#todaysgamespanel')[0];
        				todaysgamespanel.add(panel);
        			}
        			else
        			{
