Ext.define('MlbApp.view.YesterdaysGames', {
	extend: 'Ext.Panel',
	alias: 'widget.yesterdaysgamespanel',
	itemId: 'yesterdaysgamespanel',
	...
	listeners: {
        afterrender: function() {
        	...
        	Ext.Ajax.request({
        		url: MlbApp.common.Globals.root + "api/games/yesterday",
        		success: function(response)
        		{
        			...
        			if(games.length<1)
        			{
        				var panel = new Ext.panel.Panel({
        		            html: '<p>&nbsp;&nbsp;&nbsp;No games played yesterday.</p>'
        				});
        				
        				var yesterdaysgamespanel = Ext.ComponentQuery.query('#yesterdaysgamespanel')[0];
        				yesterdaysgamespanel.add(panel);
        			}
        			else
        			{
